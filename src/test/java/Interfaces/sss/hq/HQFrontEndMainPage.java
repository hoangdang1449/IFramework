...
public class HQFrontEndMainPage {
    ...
    private static By txtProductShortNameVN = IFrameworkElementDefinition.Xpath(
    ...
    private static By cboRetailBusinessType = IFrameworkElementDefinition
            .Xpath("//*[@id=\"app\"]/div/div/div/div/section[2]/div[3]/div[1]/div/div[2]/div/div/select");
    private static By txtProductFullNameVN = IFrameworkElementDefinition.Xpath(
            "//*[@id=\"app\"]/div/div/div/div/section[2]/div[3]/div[2]/div/div/div/div/div[1]/div/div/div[1]/input");
    private static By txtProductShortNameEN = IFrameworkElementDefinition.Xpath(
            "//*[@id=\"app\"]/div/div/div/div/section[2]/div[3]/div[2]/div/div/div/div/div[2]/div/div/input");
    private static By txtProductFullNameEN = IFrameworkElementDefinition.Xpath(
    ...
    private static By cboPreservationTemperature = IFrameworkElementDefinition.Xpath(
    ...
    private static By cboBarcodeIssuer = IFrameworkElementDefinition.Xpath(
            "//*[@id=\"app\"]/div/div/div/div/section[2]/div[3]/div[2]/div/div/div/div/div[13]/div/div/select");
    private static By cboBrandName = IFrameworkElementDefinition
            .Xpath("//*[@id=\"react-select-7--value\"]/div[2]/input");
    private static By txtMiniumDisplayQty = IFrameworkElementDefinition.Xpath(
