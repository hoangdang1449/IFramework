...
public class HQLoginPage {
  public static By txbUser =
      IFrameworkElementDefinition.Xpath("//input[@type='text' and @placeholder='Username']");
  public static By txbPass =
      IFrameworkElementDefinition.Xpath("//input[@type='password' and @placeholder='Password']");
  public static By btnLogin =
      IFrameworkElementDefinition.Xpath("//input[@type='button' and @value='Log in']");
