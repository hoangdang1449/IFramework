...
public class IFrameworkSetting {
	...
	*//**
	 * Set path for IE Driver Executable (e.g: IFrameworkSetting.setIeDriverExecutable("C:\\IEDriverServer.exe");)
	...
	*//**
	 * Set path for Chrome Driver Executable (e.g: IFrameworkSetting.setIeDriverExecutable("C:\\chromedriver.exe");)
	 * @param ieDriverExecutable
	 *//*
